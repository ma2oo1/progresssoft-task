...
- Create Angular project with ng: `ng new progresssoft-task.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`progresssoft-task.client.esproj`).
